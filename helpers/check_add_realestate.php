...
if (isset($_POST["submit"])) {
    ...
    $realestatesDb->add_realestate($_POST["nadpis"], $_POST["cena"], $_POST["lokalita"], $_POST["typNemovitosti"], $_POST["plocha"], $_POST["popis"], $_POST["fileToUpload"],  date('Y-m-d H:i:s'), $_SESSION["userId"]);
